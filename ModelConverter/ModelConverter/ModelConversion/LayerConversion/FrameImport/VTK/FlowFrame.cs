    ...
    class FlowFrame : VTKFrame
    {
        ...
        private void ImportVerticesAndVectors()
        {
            ...
            for (int i = 0; i < numberOfVertices; i++)
            {
                ...
                Vertices[currentVertexNumber] = vtkModel.GetPoint(cellIds[1]);
                Vectors[currentVertexNumber] = vtkModel.GetPoint(cellIds[0]).Zip(vtkModel.GetPoint(cellIds[1]), (vector, vertex) => vertex - vector).ToArray();
